...
// let name = prompt("Как вас зовут?","Иван");
// alert(name);
...
// let string2 = 'World';
//
// let resString = string1 + string2; // конкатенация значений переменных string1 и string2
//
...
// let a = prompt("Сколько вам лет?", "18");
//
// if (a >= "18") {
...
// let a = prompt("Введите слово Hello, или World", "Hello");
//
// if (a == "Hello" || a == 'hello') {
...
// let str = "Угадайте задуманный цвет с пяти попыток.";
//
// let maxAttempt = 5;   // Допустимое количество попыток.
// let attempt = 0;      // Счетчик попыток.
// let color = "black";    // Задуманный цвет.
// let value;
//
...
// let count = prompt("Сколько Вы хотите провести иттераций?");
// let exit = prompt("На какой итерации выйти из цикла?");
//
...
// let count = prompt("Сколько Вы хотите провести итераций?");
// let exit = prompt("Какое число вы не хотите увидеть?");
//
// for (let i = 0; i < count; i++) {
//     if (i == exit) {
//         document.write("<br>");
